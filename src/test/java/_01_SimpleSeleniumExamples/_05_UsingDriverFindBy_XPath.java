 ...
 */
public class _05_UsingDriverFindBy_XPath {
	@Test
	public void test() {
		...
		driver.findElement(By.xpath("//*[@id=\"employee_username\"]")).sendKeys("company.admin");
		//Use the driver to locate the password textbox and set it's value
		driver.findElement(By.xpath("//*[@id=\"employee_password\"]")).sendKeys("test");
		//Use the driver to locate the login button and click it
		driver.findElement(By.xpath("//*[@id=\"new_employee\"]/div[2]/div[3]/input")).click();
